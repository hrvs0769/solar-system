// 行星中文科普资料（NASA/JPL 数值）。description=课堂讲解版，kid=儿童模式版。
export const FACTS = {
  sun: {
  ...
  mercury: {
    ...
    kid:'水星是离太阳最近的小个子，跑得最快，白天很热，晚上很冷。',
    reviewStatus:'pending', reviewer:'', reviewedAt:'',
  },
  venus: {
    ...
    kid:'金星是天空中最亮的那颗星，厚厚的云把它裹得严严实实，里面非常热。',
  ...
  mars: {
    ...
    kid:'火星是一颗红色的星球，上面有高高的火山，科学家派机器人去看过它。',
    reviewStatus:'pending', reviewer:'', reviewedAt:'',
  },
  jupiter: {
    ...
    kid:'木星是最大的行星，身上有一个大大的红斑，那是一场刮了很久很久的大风。',
    reviewStatus:'pending', reviewer:'', reviewedAt:'',
  },
  saturn: {
    ...
    kid:'土星戴着漂亮的呼啦圈，那是它的光环，由冰块和小石头组成。',
    reviewStatus:'pending', reviewer:'', reviewedAt:'',
  },
  uranus: {
  ...
  moon: {
    ...
    kid:'月球是地球的好朋友。它自己不会发光，我们看到的月光是太阳照上去的。',
