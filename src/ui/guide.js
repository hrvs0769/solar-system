...
const STEPS=[
  ...
  ['教学模块与快捷键','顶栏可切换 月相实验室/日月食/卫星。空格=暂停，H=隐藏界面（投屏更干净），F1=帮助。给小朋友看时点 🌱 开启儿童模式：字更大、按钮更少、带语音朗读。'],
  ['进入全屏，课堂更清爽','投影上课时建议全屏：没有浏览器边框，小朋友看得更清楚。点下面按钮或顶栏 ⛶ 都可以，按 Esc 退出。'],
];
  ...
  const show=()=>{
    ...
    openModal('guide', `
      ...
      <div style="margin-top:14px;display:flex;gap:8px;justify-content:flex-end">
        ...
        ${i===STEPS.length-1?'<button class="tc-btn" id="g-fs">⛶ 立即全屏</button>':''}
    ...
    document.getElementById('g-fs')?.addEventListener('click',()=>document.documentElement.requestFullscreen?.());
